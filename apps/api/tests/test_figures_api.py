...
from yakudoku_core.db.models import Article, ExplainerFigure, Job, OverviewFigure, User
...
def _build_app() -> FastAPI:
    ...
    from yakudoku_api.routers import figures
...
async def test_get_overview_figure_returns_current_version_and_versions_list(
    ...
    assert body["dsl"]["footer"]["generated_by"] == "✦ AI 生成 · 訳読"
