...
- ライセンス縮退(docs/09 §5.2): ``yakudoku_core.licenses.classify_license`` の
...
``yakudoku_api.ratelimit.match_rule`` への専用ルール追加が必要(本タスクの所有外の
...
from yakudoku_api.deps import DbDep
from yakudoku_api.errors import ProblemException
from yakudoku_api.schemas.library import author_names, authors_short
from yakudoku_api.schemas.share import (
    ShareCollectionInfo,
    ShareCollectionItem,
