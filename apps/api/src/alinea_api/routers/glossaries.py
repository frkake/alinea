...
- scope=user / paper の CRUD は :mod:`alinea_core.translation.glossary` に委譲する。
...
import structlog
from alinea_core.db.models import Glossary, GlossaryTerm, LibraryItem, User
from alinea_core.jobs.store import JobStore
from alinea_core.translation import glossary as glossary_core
from alinea_core.translation.pipeline import resolve_display_units
...
from alinea_api.schemas.glossaries import (
...
log = structlog.get_logger("alinea.api.glossaries")

router = APIRouter(tags=["glossaries"])

_ON_DEMAND_PRIORITY = 100  # plans/06 §3.1: 訳語変更起因の再翻訳は alinea:interactive 相当
