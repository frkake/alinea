...
:class:`ArticleSources` にまとめる。プロンプト(:mod:`yakudoku_core.article.prompts`)は
...
from yakudoku_core.licenses import LicensePolicy, classify_license
from yakudoku_core.search.rebuild import BlockIndexRow, compute_index_rows
from yakudoku_core.translation.pipeline import BLOCKING_FLAGS, resolve_display_units
