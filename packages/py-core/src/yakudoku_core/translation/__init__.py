...
プレースホルダプロトコル(:mod:`~yakudoku_core.translation.placeholder`)に加え、M0-17 で
用語スナップショット(:mod:`~yakudoku_core.translation.glossary`)・プロンプト
(:mod:`~yakudoku_core.translation.prompts`)・パイプライン駆動
(:mod:`~yakudoku_core.translation.pipeline`)を公開する。
"""
