...
LLM 実行は :mod:`yakudoku_llm`(``LLMRouter.complete(mode="structured")``)へ委譲する。
...
from yakudoku_llm.errors import ErrorKind, ProviderChainExhausted
...
from yakudoku_core.translation.prompts import (
    TargetBlock,
    TranslationBatchOut,
    build_paper_context,
