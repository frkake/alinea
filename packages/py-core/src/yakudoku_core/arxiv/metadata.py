...
from yakudoku_core.arxiv.fetch import FetchError, make_arxiv_client
from yakudoku_core.arxiv.ids import ArxivId, api_query_url, oai_url
from yakudoku_core.arxiv.licenses import normalize_license_url
from yakudoku_core.licenses import LicenseId
...
async def _fetch_metadata(
    ...
    base_url = settings.yakudoku_arxiv_base_url or None
    try:
