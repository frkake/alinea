...
class CoreSettings(BaseSettings):
    ...
    # DB / Redis / S3
    database_url: str = "postgresql+asyncpg://alinea:alinea@localhost:5432/alinea"
    redis_url: str = "redis://localhost:6379/0"
    s3_endpoint_url: str = "http://localhost:9000"
    s3_public_endpoint_url: str = "http://localhost:9000"
    s3_region: str = "us-east-1"
    s3_access_key_id: str = "alinea"
    s3_secret_access_key: str = "alinea-dev-secret"  # noqa: S105
    s3_bucket_sources: str = "alinea-sources"
    s3_bucket_assets: str = "alinea-assets"

    # 認証・暗号化(既定値は開発用プレースホルダ。本番は .env で必ず上書きする)
    session_secret: str = "change-me-64-hex"  # noqa: S105
    alinea_key_encryption_secret: str = ""
    extension_allowed_origins: str = ""

    # 外部
    arxiv_user_agent: str = "alinea/1.0 (contact: admin@alinea.app)"
    ...
    alinea_openai_base_url: str = ""
    alinea_anthropic_base_url: str = ""
    alinea_google_base_url: str = ""
